...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wz864ei.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wz864ei.containers.anotherwebservice.com/
...
```
git clone git@github.com:Devl-byte/container-wz864ei.git
cd container-wz864ei
```
...
```
docker attach container-wz864ei
```
